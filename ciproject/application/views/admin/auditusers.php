...
?>                    
                    <tr>
                      ...
                      <td><?php echo htmlentities($row->audit_id)?></td>
                      <td><?php echo htmlentities($row->username)?></td>
                      <td><?php echo htmlentities($row->hostname)?></td>
                      <td><?php echo htmlentities($row->hostip)?></td>
                      <td><?php echo htmlentities($row->session_id)?></td>
                      <td><?php echo htmlentities($row->action)?></td>
                      <td><?php echo htmlentities($row->event_desc)?></td>
                      <td><?php echo htmlentities($row->ts)?></td>
