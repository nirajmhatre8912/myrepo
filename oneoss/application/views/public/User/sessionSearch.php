           ...
           <!--     <div class="row"> -->
               ...
               <div class="col-md-12">    
                        ...
                        <?php if( in_array("viadrpt", $roles) ): ?>        
                                        ...
                                        <input type="text" class="form-control" name="search_text" id="search_text" placeholder="Search by Session Details" style="padding-left=20px;" />
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url("index.php/user/Ajax_Search/fetch_session"); ?>",
   method:"POST",
   data:{query:query},
