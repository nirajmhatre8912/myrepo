							...
							<!--crtuser,viaudi -->
								<?php if( in_array("viaudi", $roles) ): ?>        
														...
														<div class="row">
                                                            ...
                                                            <div class="form-group">
                                                            <br>
                                                                <button id="sbtbutton" name="sbtbutton" class="form-control btndel btn btn-block btn-outline-danger btn-sm" onclick="date_wise_search()">submit</button>
                                                            </div>
...
<script>
            ...
            $('#reservationtime').daterangepicker({
                ...
                function date_wise_search()
                {
                    ...
                    $.ajax({
                        type : 'POST',
                        url : '<?php echo base_url("index.php/user/Create_User/get_datewise_session"); ?>',
                        data : {
                            'dateTime' : dateTime
                        },
